        ...
        public static void Seed(IApplicationBuilder app)
        {
            ...
            if (!context.Blogs.Any())
            {
                context.Blogs.AddRange(
                        ...
                        new Blog() {Title="Blog Title 2", Description="Blog Description 2", Body="Blog Body 2",Image="2.jpg",Date=DateTime.Now.AddDays(-6),isApproved=true,CategoryId=2 },
                        new Blog() {Title="Blog Title 3", Description="Blog Description 3", Body="Blog Body 3",Image="3.jpg",Date=DateTime.Now.AddDays(-7),isApproved=false,CategoryId=1 },
